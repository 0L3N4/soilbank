                ...
                <main className="main-content">
                  ...
                  <section className="how-it-works">
                    ...
                    <p className="section-description">
                      Invest in regenerative agriculture effortlessly and track
                    ...
                    <div className="cards-container">
                      <div className="card">
                        ...
                        <p className="card-description">
                          Measure soil health with key metrics like nutrients,
                      ...
                      <div className="card">
                        ...
                        <p className="card-description">
                          See both environmental and financial impact through
                      ...
                      <div className="card">
                        ...
                        <p className="card-description">
                          All farms are carefully checked to ensure genuine
                        ...
                        <div className="process-steps">
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Upload soil tests, photos, and basic farm
                              information.
                            </p>
                          </div>
                          <div className="process-step">
                            ...
                            <h4 className="step-title">
                              Receive Your Soil Score
                            </h4>
                            <p className="step-description">
                              Get a clear Soil Health Score based on key
                              indicators.
                            </p>
                          </div>
                          <div className="process-step">
                          ...
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Connect with investors and begin restoring your
                              soil.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="process-column">
                        ...
                        <div className="process-steps">
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Browse verified regenerative farms by region,
                              type, and score.
                            </p>
                          </div>
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Review projects with clear impact and return
                              metrics.
                            </p>
                          </div>
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Fund soil regeneration projects aligned with your
                              goals.
                            </p>
                          </div>
                          <div className="process-step">
                            ...
                            <p className="step-description">
                              Follow soil improvements and environmental
                  ...
                  <section className="cta-section">
                    ...
                    <p className="cta-description">
                      Whether you're a farmer rebuilding your land or an
                      investor pursuing purpose-driven returns, SoilBank
